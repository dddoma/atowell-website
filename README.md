...
## 목적
- 환자가 첫 화면에서 피부질환·피부미용·비만치료의 세 진료 축을 이해
- 비급여 가격, 진료시간·문의, 오시는 길을 빠르게 확인
- 피부질환/비만 의료정보를 진료의 연장선으로 확장
...
특정 약제나 가격을 병원의 정체성보다 앞세우지 않습니다. 의료정보는 원장 검토 전 상세 공개 글로 게시하지 않습니다.
